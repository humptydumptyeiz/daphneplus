...
from daphneplus.testing import DaphneTestingInstance, TestApplication
...
class DaphneTestCase(unittest.TestCase):
    ...
    def run_daphne_raw(self, data, timeout=1):
        """
        Runs daphneplus and sends it the given raw bytestring over a socket. Returns what it sends back.
        """
